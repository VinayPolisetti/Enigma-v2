...
export default class received_files extends Component {
  ...
  async getfiles(){
   ...
   const userfiles=await userobj.methods.getreceivedfiles().call({from:accounts[0]});
...
render() {
    return (
      <div className="App">
        ...
        <div style={{ margin: "7% 13%" }}>
          <h4 className="font-weight-bold my-4">Received Files</h4>
