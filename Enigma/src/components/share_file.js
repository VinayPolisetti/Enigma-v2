...
export default class files extends Component {
  ...
  sharefile = async event => {
    ...
    try {
      ...
      console.log("Public_Key:: " + republickey);
    ...
    return (
      <div class="App">
        ...
        <div style={{ margin: "7% 13%" }}>
          <h4 className="font-weight-bold my-4">Share Files via AccountID</h4>
          <Form onSubmit={this.sharefile}>
            ...
            <div>
              <input type="file" style={{ margin:'10px 0px 10px 100px' }} onChange={this.captureFile} id="ipfs" />
            </div>
            <br />
