...
export default class profile extends Component {
 ...
 render() {
  ...
  <div>
    <label style={{fontWeight: 'bold'}}>Name:</label> {this.state.usernamename}
  </div>
  <div>
    <label style={{fontWeight: 'bold'}}>Username:</label> {this.state.username}
  </div>
  <div>
    <label style={{fontWeight: 'bold'}}>Address:</label> {this.state.usernameadd}
  </div>
</div> 
         <br />
          <h4 className="font-weight-bold my-4">Common Groups</h4>
